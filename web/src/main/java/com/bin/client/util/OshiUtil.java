...
//      System.out.println("  release date: " + (firmware.getReleaseDate() == null ? "unknown": firmware.getReleaseDate() == null ? "unknown" : FormatUtil.formatDate(firmware.getReleaseDate())));
    ...
    private static void printProcessor(CentralProcessor processor) {
        ...
        System.out.println("MaxFreq" + processor.getMaxFreq());
        System.out.println("vendorFreq :" + vendorFreq);
        System.out.println("Identifier: " + processorIdentifier);
    ...
    private static void printCpu(CentralProcessor processor) {
        ...
        System.out.println("totalCpu :" + totalCpu  +" cover-" + 1000000000 * totalCpu + " idle - " + idle);
